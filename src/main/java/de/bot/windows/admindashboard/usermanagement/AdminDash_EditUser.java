...
public class AdminDash_EditUser extends JPanel {

    UpdateHandler updateHandler = UpdateHandler.getInstance();
    AccountHandler accountHandler = AccountHandler.getInstance();
    WindowHandler windowHandler = new WindowHandler();

    public AdminDash_EditUser(ExternalUser externalUser) {
        ...
        JLabel titleLabel = new JLabel("Benutzer bearbeiten");
        ...
        JLabel saveFeedback = new JLabel("Der Benutzer wurden erfolgreich bearbeitet.");
        ...
        username.setText(externalUser.getUsername());
        ...
        channelID.setText(externalUser.getChannelID());

        if (externalUser.getChannelID().equalsIgnoreCase("ChannelID")) {
        ...
        password.setText(externalUser.getPassword());
        password.setFont(new Font("Arial", Font.PLAIN, 20));

        accessToken.setBorder(null);
        accessToken.setVisible(true);
        accessToken.setBackground(new Color(0x262626));
        accessToken.setText(externalUser.getAccessToken());
        if (externalUser.getAccessToken().equalsIgnoreCase("AccessToken")) {
        ...
        refreshToken.setText(externalUser.getRefreshToken());

        if (externalUser.getRefreshToken().equalsIgnoreCase("RefreshToken")) {
        ...
        for (AccountRank accountRank : accountHandler.getAccountRanks().values()) {
            ...
            i++;
            if (externalUser.getAccountRank().getTitle().equalsIgnoreCase(accountRank.getTitle())) {
                selectedIndex = i - 1;
            }
        }
        ...
        selectRank.setSelectedIndex(selectedIndex);
        ...
        saveButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                try {
                    ...
                    externalUser.setAccountRank(accountHandler.getRank(selectRank.getSelectedItem().toString()));


                    String respone = bufferedReader.readLine();

                    if (respone.equalsIgnoreCase("EDITED")) {
                        saveFeedback.setText("Der Benutzer wurden erfolgreich bearbeit.");
                        saveFeedback.setBackground(new Color(0x05A489));
                        saveFeedback.setVisible(true);
        ...
        saveFeedback.setBounds(200, 120, 625, 40);
        background.setBounds(20, 150, 440, 290);
    }
}
